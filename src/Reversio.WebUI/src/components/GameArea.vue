    ...
    <div class="ui relaxed grid">
      ...
      <div class="ten wide column">
        ...
        <div class="ui middle aligned divided list games" v-if="activeGames.length > 0">
          <div class="item" v-for="game in activeGames">
            ...
            <i class="large adjust icon image"></i>
            <div class="content">
              <div class="header">
                {{game.blackPlayerStatus.name}} - {{game.whitePlayerStatus.name}}
                :
                [{{game.blackPlayerStatus.score}}] - [{{game.whitePlayerStatus.score}}]
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="four wide column">
        ...
        <div class="ui middle aligned divided list">
          <div class="item" v-for="player in registeredPlayers" v-if="registeredPlayers.length > 0">
            <div class="right floated content">
