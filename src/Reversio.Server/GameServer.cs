...
namespace Reversio.Server
{
    public class GameServer
    {
        ...
        //public IReadOnlyList<Position> MakeMove(Guid gameId, Participant participant, Position position)
        //{
        //    var game = _activeGames[gameId];
        //    var player = game.GetActivePlayer(participant.Name);
        ...
        //{
        //    GameStarted?.Invoke(this, player, new GameStartedEventArgs(currentState, player.Disc));
        //}
    }
}
